...
* `<op>`: é um caracter que especifica o comportamento do programa:
   ...
   - e : o programa deverá aplicar ao `texto` a cifra de transposição (ver Secção [2.3](#transp2)) e apresentar o resultado na consola.     Esta opção é uma opção extra e a avaliação desta funcionalidade será feita separadamente - (ver Secção [2.3](#transp2))
